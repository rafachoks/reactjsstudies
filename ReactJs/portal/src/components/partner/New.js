...
export default class New extends Component{
    constructor(props) {
       ...
       handleSubmit = (e, message) => {
         ...
         .catch( function () {
            console.log("Não foi possivel cadastrar o usuário, é possivel que ele ja exista");
          });
       }
    render(){
        ...
        return(
          ...
          <fieldset className='form-group'>
              <ReactFormLabel htmlFor='formName' title='Nome:' />
          ...
          <fieldset className='form-group'>
              ...
              <input id='formCpf' className='form-input' name='cpf' type='text' require="true" onChange={this.handleChange} value={this.state.cpf} />
          </fieldset>
          <fieldset className='form-group'>
